...
public class MainPageServlet extends HttpServlet {	
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {		
		...
		if(query==null) {
			...
			logger.info("Null Query -> Redirigiendo al visitante de la base URL a " + redirect);
	    ...
	    if(room_key==null || room_key.equals("")) {
	        ...
	        //String room_link = "http://"+server_name+"/"+PATH+"/?r=" + room_key;
	        //System.out.println(room_link);
	        if(debug!=null)
