...
public class HallMessageServlet  extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(HallMessageServlet.class.getName()); 
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {		
		...
		//HallProcessingSignal.send(message,token);
		/*
