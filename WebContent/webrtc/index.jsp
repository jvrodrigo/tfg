...
<script type="text/javascript" src="js/mediaControls.js"></script>
...
var channelToken = <%=request.getAttribute("token")%>;
//var roomKey = '{room_key}'
var roomKey = <%=request.getAttribute("roomKey")%>;
...
function onChannelError() {
	//console.log('Error del canal para el token: {token}');
	console.log('Error del canal para el token: ' + channelToken);
}
function onChannelClosed() {
	//console.log('Canal cerrado para el token: {token}');
	//alert('Canal cerrado por el usuario ' + (initiator + 1)	+ ' con el token {token}.');
